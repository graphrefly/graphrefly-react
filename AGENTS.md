...
Read `CLAUDE.md` for repository scope and authority boundaries. This repository owns its React binding
and presentation work; GraphReFly engine and protocol authority remain in `~/src/graphrefly-ts` and
`~/src/graphrefly`.
